...
@section('content')
    ...
    <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
        ...
        <form class="d-none d-md-flex ms-4 my-auto">
            <input class="form-control border-0" type="search" placeholder="Search Post">
        </form>
        <div class="navbar-nav align-items-center ms-auto">
            <div class="nav-item">
                <a href="{{ route('news') }}" class="nav-link">
                    <i class="fa fa-newspaper me-lg-2"></i>
                    <span class="d-none d-lg-inline-flex">News</span>
                </a>
            </div>
    ...
    <div class="d-flex flex-column min-vh-100">
        @if (Auth::user()->role == 'admin')
            <!-- Sale & Revenue Start -->
            <div class="container-fluid mb-auto pt-4 px-4">
                <div class="row g-4">
            ...
            <div class="container-fluid pt-3 px-5">
                <div class="row g-4">
                    <div class="alert alert-danger d-flex align-items-center" role="alert">
                        <i class="fa fa-exclamation-triangle ms-2 me-3" aria-hidden="true"></i>
                        <div>
                            Harap tidak mengirimkan tautan, gambar, atau konten yang mengandung unsur SARA, pornografi, atau
                            hal tidak senonoh lainnya. Tindakan melanggar dapat menyebabkan akun Anda diblokir secara
                            permanen.
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="card-body text-start position-relative d-flex flex-column"
                                                ...
                                                <div class="mt-auto d-flex justify-content-end gap-2">
                                                    <form id="like-form-{{ $post->id }}"
                                                        action="{{ route('like.store') }}" method="POST"
                                                        style="display: none;">
                                                        @csrf
                                                    ...
                                                    <button type="button" class="btn btn-outline-dark btn-md"
                                                        ...
                                                        data-bs-target="#komentar{{ $post->id }}"><i
        ...
        <!-- Footer Start -->
        <div class="container-fluid mt-auto pt-4 px-0">
            <div class="bg-light rounded-top p-4">
                <div class="row">
                    <div class="col-12 col-sm-6 text-center text-sm-start">
                        &copy; <a href="/">postgram.</a> All Right Reserved.
                    </div>
                </div>
            </div>
        </div>
...
<script>
    // Menyimpan posisi scroll sebelum form disubmit
    ...
    // Menyimpan posisi scroll saat form disubmit
