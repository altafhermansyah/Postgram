...
@section('content')
    ...
    <div class="container-fluid pt-4 px-4">
        <div class="row g-4">
            <div class="col-sm-12">
                <div class="bg-light text-center my-auto rounded p-4 mb-4">
                    <h4><i class="fa fa-fire me-2"></i>Popular Posts</h4>
                </div>
            </div>
        </div>
            ...
            @foreach ($posts->take(3) as $post)
                <div class="col-lg-4">
                    <div class="card" style="width: 20rem;">
                        <!-- Gambar Berita -->
                        <img src="{{ asset('/storage/images/' . $post->image) }}" class="mx-auto card-img-top"
                            alt="{{ $post->title }}" style="width: 200px; height: 200px">
                        ...
                        <div class="card-footer text-muted">
                            <div class="mt-auto d-flex justify-content-end gap-2">
                                <form id="like-form-{{ $post->id }}" action="{{ route('like.store') }}" method="POST"
                                    style="display: none;">
                                    @csrf
                                ...
                                @endif
                                <button type="button" class="btn btn-outline-dark btn-md" data-bs-toggle="modal"
